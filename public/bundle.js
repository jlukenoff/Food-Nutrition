...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--5!./App.css */ "./node_modules/css-loader/index.js?!./client/Components/App.css");
...
var _QueryForm = __webpack_require__(/*! ./QueryForm/QueryForm */ "./client/Components/QueryForm/QueryForm.jsx");

var _QueryForm2 = _interopRequireDefault(_QueryForm);

var _ResultsList = __webpack_require__(/*! ./ResultsList/ResultsList */ "./client/Components/ResultsList/ResultsList.jsx");
...
var _App = __webpack_require__(/*! ./App.css */ "./client/Components/App.css");
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    key: 'updateSpecData',
    value: function () {
      function updateSpecData(which, val) {
        var newState = {};
        newState[which] = val;
    ...
    value: function () {
      function handleSubmit(e) {
        ...
        var _state = this.state,
            proteinMin = _state.proteinMin,
            proteinMax = _state.proteinMax,
            sugarMin = _state.sugarMin,
            sugarMax = _state.sugarMax,
            carbMin = _state.carbMin,
            carbMax = _state.carbMax,
            fatMin = _state.fatMin,
            fatMax = _state.fatMax;

        fetch('/food?203=' + String(proteinMin) + '-' + String(proteinMax) + '&204=' + String(sugarMin) + '-' + String(sugarMax) + '&205=' + String(carbMin) + '-' + String(carbMax) + '&269=' + String(fatMin) + '-' + String(fatMax)).then(function (chunk) {
          return chunk.json();
        }).then(function (results) {
          return _this2.setState({ results: results });
        })['catch'](function (err) {
          return console.error('Error fetching data: ' + String(err));
        });
      }
...
/***/ "./client/Components/QueryForm/QueryForm.css":
/*!***************************************************!*\
  !*** ./client/Components/QueryForm/QueryForm.css ***!
  \***************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--5!./QueryForm.css */ "./node_modules/css-loader/index.js?!./client/Components/QueryForm/QueryForm.css");
...
/***/ "./client/Components/QueryForm/QueryForm.jsx":
/*!***************************************************!*\
  !*** ./client/Components/QueryForm/QueryForm.jsx ***!
  \***************************************************/
/*! no static exports found */
...
var _QueryForm = __webpack_require__(/*! ./QueryForm.css */ "./client/Components/QueryForm/QueryForm.css");
...
var QueryForm = function QueryForm(_ref) {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      'p',
      null,
      'Enter your desired nutritional information...'
    ),
    _react2['default'].createElement(
      'div',
      { className: _QueryForm2['default'].inputContainer },
      _react2['default'].createElement(
        'div',
        { className: _QueryForm2['default'].inputFieldContainer },
        _react2['default'].createElement(
          'p',
          null,
          'Protein'
        ),
        _react2['default'].createElement('input', { type: 'text', placeholder: 'min', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('proteinMin', +e.target.value);
            }
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'max', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('proteinMax', +e.target.value);
            }
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'min', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('fatMin', +e.target.value);
            }
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'max', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('fatMax', +e.target.value);
            }
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'min', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('carbMin', +e.target.value);
            }
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'max', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('carbMax', +e.target.value);
            }
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'min', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('sugarMin', +e.target.value);
            }
        ...
        _react2['default'].createElement('input', { type: 'text', placeholder: 'max', className: _QueryForm2['default'].inputField, onKeyUp: function () {
            function onKeyUp(e) {
              return handleInput('sugarMax', +e.target.value);
            }
    ...
    _react2['default'].createElement(
      'button',
      { type: 'button', className: _QueryForm2['default'].submitBtn, onClick: handleSubmit },
      'Find Foods'
    )
  );
};
...
QueryForm.propTypes = {
  handleInput: _propTypes2['default'].func.isRequired,
...
/***/ "./client/Components/ResultsList/ResultsList.css":
/*!*******************************************************!*\
  !*** ./client/Components/ResultsList/ResultsList.css ***!
  \*******************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--5!./ResultsList.css */ "./node_modules/css-loader/index.js?!./client/Components/ResultsList/ResultsList.css");
...
/***/ "./client/Components/ResultsList/ResultsList.jsx":
/*!*******************************************************!*\
  !*** ./client/Components/ResultsList/ResultsList.jsx ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./node_modules/css-loader/index.js?!./client/Components/App.css":
/*!*********************************************************************!*\
  !*** ./node_modules/css-loader??ref--5!./client/Components/App.css ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?!./client/Components/QueryForm/QueryForm.css":
/*!*************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5!./client/Components/QueryForm/QueryForm.css ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// exports
exports.locals = {
	"inputContainer": "QueryForm__inputContainer___32W-8",
	"inputFieldContainer": "QueryForm__inputFieldContainer___L7NlC",
	"submitBtn": "QueryForm__submitBtn___3WR-S",
	"inputField": "QueryForm__inputField___prTOj"
};

/***/ }),

/***/ "./node_modules/css-loader/index.js?!./client/Components/ResultsList/ResultsList.css":
/*!*****************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5!./client/Components/ResultsList/ResultsList.css ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5!./node_modules/normalize.css/normalize.css ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../css-loader??ref--5!./normalize.css */ "./node_modules/css-loader/index.js?!./node_modules/normalize.css/normalize.css");
